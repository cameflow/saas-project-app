class ArtefactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artefact.save
        format.html { redirect_to tenant_project_url(tenant_id: Tenant.current_tenant_id, id: @artefact.project_id), notice: 'Artefact was successfully created.' }
  ...
  def destroy
    @artefact.destroy
    respond_to do |format|
      format.html { redirect_to tenant_project_url(tenant_id: Tenant.current_tenant_id, id: @artefact.project_id), notice: 'Artefact was successfully destroyed.' }
